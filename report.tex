...
by Velikhov (1959) and Chandrasekhar (1960) and was later re-discovered by 
Balbus and Hawley (1998) for astrophysical applications. MRi has since then 
...
stability criterion (Rayleigh 1916) against centrifugal instability. Thus, 
there has to be other mechanisms that generates turbulence and this is where 
...
well, e.g Earth's magnetic field. It is used to better understand how planetary
